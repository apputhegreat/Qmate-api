    ...
    return (
      <Menu mode="horizontal"
        ...
        <Menu style={{ float: 'right' , marginTop: 10, fontSize: '26px', backgroundColor: '#05A4DE', borderColor : '#05A4DE'}} theme="dark" mode="horizontal">
          <Menu.Item key="2" style={{backgroundColor: 'rgb(5, 164, 222)'}}>
            <a href="/quotelist">
            <button type='button' className='btn btn-primary'
              style={{backgroundColor: 'rgb(5, 164, 222)', borderColor: '#05A4DE', borderWidth: 0}}
              >Quote List</button></a>
          </Menu.Item>
          <Menu.Item key="3" style={{backgroundColor: 'rgb(5, 164, 222)'}}>
            <button type='button' className='btn btn-primary'
              style={{backgroundColor: '#05A4DE', borderColor: '#05A4DE', borderWidth: 0}}
              onClick={() => this.onClickAddAuthors()}>Add Authors</button>
          </Menu.Item>
          <Menu.Item key="4" style={{backgroundColor: 'rgb(5, 164, 222)'}}>
            <a href="/authorslist">
            <button type='button' className='btn btn-primary'
              style={{backgroundColor: '#05A4DE', borderColor: '#05A4DE', borderWidth: 0}}
              >Authors List</button></a>
          </Menu.Item>
          <Menu.Item key="5" style={{backgroundColor: 'rgb(5, 164, 222)'}}>
            <button type='button' className='btn btn-primary'
              style={{backgroundColor: '#05A4DE', borderColor: '#05A4DE', borderWidth: 0}}
